                        ...
                        <div className="flex-1 flex flex-col gap-10">
                            ...
                            <div>
                                ...
                                <div className="border border-[#B59E74] rounded-lg p-6 max-w-sm bg-white shadow-sm">
                                    <h4 className="text-xl text-[#B59E74] font-serif mb-2">Rev. Fr. Fernando B. Jardin Jr.</h4>
                                    <p className="text-gray-600 font-serif text-sm">Parish Priest and Rector</p>
                                </div>
                            </div>
