            ...
            <div className="bg-[#F6F5ED] w-full max-w-5xl max-h-[90vh] overflow-y-auto rounded-3xl shadow-2xl relative scrollbar-hidden">
                ...
                <form className="p-8 space-y-10">
                    ...
                    <p className="text-xs text-gray-500 italic leading-relaxed text-center max-w-3xl mx-auto border-b pb-6 border-gray-200">
                        ...
                        <br/>
                        <span className="text-[11px] text-gray-400">Panuto: Sagutan ang mga blanko ng tama sa pamamagitan ng pagsusulat gamit ang MALALAKING LETRA. Sumulat ng maayos. Kopyahin ang mga detalye nang ayon sa nakasulat sa Certificate of Live Birth ng ikakasal.</span>
                    </p>
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <input type="text" className="p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#B59E74] bg-white text-gray-700" placeholder="Surname" />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                                <div className="flex flex-col gap-1 md:col-span-6">
                                    ...
                                    <input type="text" className="p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#B59E74] bg-white text-gray-700" placeholder="Complete Address" />
                                </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <input type="text" className="p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#B59E74] bg-gray-50 text-gray-700" placeholder="₱" />
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="flex flex-col gap-1">
                                    <label className="text-xs font-bold text-gray-600">Official Receipt No.</label>
                                    <input type="text" className="p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#B59E74] bg-gray-50 text-gray-700" />
                                </div>
                                <div className="flex flex-col gap-1">
                                    <label className="text-xs font-bold text-gray-600">Date of Reservation</label>
                                    <input type="date" className="p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#B59E74] bg-gray-50 text-gray-700" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#B59E74]/10 p-6 rounded-xl border border-[#B59E74]/30 shadow-sm mt-8">
                        ...
                        <div className="flex flex-col gap-2 text-sm text-gray-700 font-serif">
                            {[
                                ...
                                <label key={idx} className="flex items-center gap-4 hover:bg-white/50 p-2 rounded-lg transition-colors cursor-pointer">
                                    <div className="w-12 flex justify-center">
                                        <input type="checkbox" className="w-5 h-5 text-[#B59E74] focus:ring-[#B59E74] border-gray-400 rounded" />
                                    </div>
                                    <div className="w-12 flex justify-center">
                                        <input type="checkbox" className="w-5 h-5 text-[#B59E74] focus:ring-[#B59E74] border-gray-400 rounded" />
                                    </div>
                    ...
                    <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                        <div className="flex flex-col gap-1 flex-1 max-w-lg">
                            ...
                            <span className="text-[11px] text-gray-400 mt-1">I declare that all the information provided above is true and correct.</span>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-y-6 gap-x-8 text-sm font-serif p-6 bg-gray-100 rounded-lg border border-gray-200">
                            ...
                            <div className="flex flex-col gap-4 md:col-span-2">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <textarea rows="3" className="border-b border-gray-400 bg-transparent focus:outline-none focus:border-[#B59E74] resize-none"></textarea>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                    <div className="flex flex-col">
                                        <span className="text-xs text-gray-500 uppercase tracking-wider">Minister of Marriage:</span>
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex items-end gap-2">
                                    <span className="text-xs text-gray-500 uppercase tracking-wider w-20">Book No:</span>
                                    <div className="border-b border-gray-400 flex-1 h-6"></div>
                                </div>
                                <div className="flex items-end gap-2">
                                    <span className="text-xs text-gray-500 uppercase tracking-wider w-20">Page No:</span>
                                    <div className="border-b border-gray-400 flex-1 h-6"></div>
                                </div>
                                <div className="flex items-end gap-2">
                                    <span className="text-xs text-gray-500 uppercase tracking-wider w-20">Line No:</span>
                                    <div className="border-b border-gray-400 flex-1 h-6"></div>
                                </div>
                                <div className="flex items-end gap-2 mt-4">
                                    <span className="text-xs text-gray-500 uppercase tracking-wider w-20">Amount:</span>
                                    <div className="border-b border-gray-400 flex-1 h-6"></div>
                                </div>
                            </div>
                        </div>
