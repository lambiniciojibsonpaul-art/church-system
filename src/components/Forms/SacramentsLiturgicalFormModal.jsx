          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-sm md:text-base text-[#B59E74] font-bold tracking-widest mt-1 uppercase">
                Request Form for Sacraments & Other Liturgical Activities
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
            ...
            <div className="flex flex-col gap-4">
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                />
                <span className="text-sm md:text-base text-gray-700">
                  Sick Call / Anointing of the Sick / Communion
                </span>
              </label>
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="radio"
                  name="requestType"
                  value="House/Commercial Blessing"
                  onChange={(e) => setRequestType(e.target.value)}
                  className="w-5 h-5 text-[#B59E74] focus:ring-[#B59E74] border-gray-300"
                />
                <span className="text-sm md:text-base text-gray-700">
                  House / Commercial Establishment Blessing
                </span>
              </label>
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                />
                <span className="text-sm md:text-base text-gray-700">
                  Funeral Mass / Mass for the Dead
                </span>
              </label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-1 md:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Complete address of the activity..."
                ></textarea>
              </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="flex flex-col gap-1">
                ...
                <input
                  type="text"
                  className="p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#B59E74] bg-white text-gray-700"
                  placeholder="If known or preferred"
                />
              </div>
              <div className="flex flex-col gap-1">
                <label className="text-xs font-bold text-gray-600">
                ...
                <textarea
                  rows="4"
                  className="p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#B59E74] bg-white text-gray-700 resize-none"
                  placeholder="Any special instructions or additional context..."
                ></textarea>
              </div>
            </div>
          </div>
