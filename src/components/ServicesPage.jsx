...
function ServicesPage() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col font-sans bg-white">
        ...
        <div className="bg-[#F6F5ED] rounded-2xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] max-w-7xl mx-auto py-16 px-8 md:px-16 text-left">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-gray-600 font-serif italic leading-relaxed text-xl">
              Whether you are preparing for a major life milestone, seeking
              spiritual guidance, or organizing an event within our parish, our
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 mb-20 items-center">
            <div className="lg:w-1/3 flex flex-col gap-4 text-center lg:text-left">
              <h3 className="text-3xl text-[#B59E74] font-serif">
                Sacramental Services
              </h3>
              <p className="text-gray-700 font-serif leading-relaxed text-lg">
                Sacraments are visible signs of God's grace. From welcoming a
                new life into the church through Baptism to uniting couples in
                Holy Matrimony, we are honored to celebrate these sacred rites
          ...
          <div className="flex flex-col lg:flex-row-reverse gap-12 lg:gap-16 items-center">
            <div className="lg:w-1/3 flex flex-col gap-4 text-center lg:text-left">
              ...
              <p className="text-gray-700 font-serif leading-relaxed text-lg">
                For administrative needs, facility bookings, and special mass
                intentions, our parish office is ready to assist. Please select
                the appropriate form below to submit your request directly to
                our team.
              </p>
            </div>
      ...
      {isBaptismModalOpen && (
        <BaptismFormModal onClose={() => setIsBaptismModalOpen(false)} />
      )}
      {isCommunionModalOpen && (
        <HolyCommunionFormModal
          onClose={() => setIsCommunionModalOpen(false)}
        />
      )}
      {isWeddingModalOpen && (
        <WeddingRegistryFormModal
          onClose={() => setIsWeddingModalOpen(false)}
        />
      )}
      {isLiturgicalModalOpen && (
        <SacramentsLiturgicalFormModal
          onClose={() => setIsLiturgicalModalOpen(false)}
        />
      )}
      {isMassIntentionModalOpen && (
        <MassIntentionFormModal
          onClose={() => setIsMassIntentionModalOpen(false)}
        />
      )}
