                            ...
                            <>
                                {baptisms.length === 0 ? (
                                    <div className="text-center text-gray-400 mt-16">
                                        ...
                                        <h3 className="text-lg font-serif">No active baptism requests.</h3>
                                    </div>
                                ) : (
                                                    ...
                                                    <tr key={bap.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                                                        ...
                                                        <td className="p-4">
                                                            <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${
                                                                bap.status === 'Pending' ? 'bg-yellow-100 text-yellow-700' : 'bg-green-100 text-green-700'
                                                            }`}>
                                                                {bap.status}
                                                            </span>
                                                        </td>
                        ...
                        {activeTab !== 'Baptisms' && (
                            <div className="text-center text-gray-400 mt-16 animate-fade-in">
                                ...
                                <p className="text-sm mt-2 max-w-md mx-auto">
                                    This database table hasn't been connected yet. Once users submit these forms, they will appear in this tab.
                                </p>
                            </div>
                        )}
                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                <div>
                                    ...
                                    <span className={`inline-block mt-1 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider ${
                                        selectedBaptism.status === 'Pending' ? 'bg-yellow-100 text-yellow-700' : 'bg-green-100 text-green-700'
                                    }`}>
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-serif text-gray-800 mt-1">
                                        {selectedBaptism.baptism_type} — {new Date(selectedBaptism.preferred_date).toLocaleDateString()}
                                    </p>
                                </div>
                            </div>
